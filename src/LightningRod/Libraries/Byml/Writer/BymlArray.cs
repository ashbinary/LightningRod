using LightningRod.Libraries.Byml.Writer.Primitives;

namespace LightningRod.Libraries.Byml.Writer
{
    public class BymlArray : BymlContainer
    {
        ...
        public override void AddInt64(long value, BymlBigDataList bigDataList) =>
            AddData(new BymlInt64Data(value, bigDataList));

        public override void AddUInt64(ulong value, BymlBigDataList bigDataList) =>
            AddData(new BymlUInt64Data(value, bigDataList));

        public override void AddDouble(double value, BymlBigDataList bigDataList) =>
            AddData(new BymlDoubleData(value, bigDataList));

        public override void AddBinary(byte[] value, BymlBigDataList bigDataList) =>
            AddData(new BymlBinaryData(value, bigDataList));

        public override void AddString(string value) =>
            AddData(new BymlStringData(value, StringTable));
